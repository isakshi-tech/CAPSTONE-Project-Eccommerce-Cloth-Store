...
const Form = () => {
  ...
  return (
    <StyledWrapper className="flex justify-center items-center h-screen">
      <form onSubmit={(e) => onSubmitHandler(e)} className="form">
        <h1 className="flex justify-center items-center climate-crisis-regular text-2xl text-[#6E0F0F]">
          {currentState}
        </h1>
        ...
        <p className="p">
          ...
          {currentState === "Sign In" ? (
            <span onClick={() => setCurrentState("Sign Up")} className="span">
              create account
            </span>
          ) : (
            <span onClick={() => setCurrentState("Sign In")} className="span">
              login
            </span>
          )}
        </p>
